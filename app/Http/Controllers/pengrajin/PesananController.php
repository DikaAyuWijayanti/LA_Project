...
class PesananController extends Controller
{
    public function index()
    {
        ...
        return view('pengrajin.pesanan.index',$data);
    }
    ...
    public function detail($id)
    {
        ...
        return view('pengrajin.pesanan.detail',$data);
    }
    ...
    public function perludicek()
    {
        ...
        return view('pengrajin.pengrajin.perludicek',$data);
    }
    ...
    public function perludikirim()
    {
        ...
        return view('pengrajin.pesanan.perludikirim',$data);
    }
    ...
    public function selesai()
    {
        ...
        return view('pengrajin.pesanan.selesai',$data);
    }
    ...
    public function dibatalkan()
    {
        ...
        return view('pengrajin.pesanan.dibatalkan',$data);
    }
    ...
    public function dikirim()
    {
        ...
        return view('pengrajin.pesanan.dikirim',$data);
    }
    ...
    public function konfirmasi($id)
    {
        ...
        return redirect()->route('pengrajin.pesanan.perludikirim')->with('status','Berhasil Mengonfirmasi Pembayaran Pesanan');
    }
    ...
    public function inputresi($id,Request $request)
    {
        ...
        $order->save();
        return redirect()->route('pengrajin.pesanan.perludikirim')->with('status','Berhasil Menginput No Resi');
    }
}
